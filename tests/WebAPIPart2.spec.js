...
test("Ecommerce website", async ({ browser }) => {
  ...
  expect(await page.locator(".cartSection h3").textContent()).toEqual(
    "ZARA COAT 3",
  );
  ...
  await page
    .locator("text=Credit Card Number ")
    .locator("..")
    .locator("input")
    .fill("4324 5432 6543 9876");
  ...
  const verifyEmail = await page
    .locator(".user__name.mt-5 input")
    .first()
    .inputValue();
